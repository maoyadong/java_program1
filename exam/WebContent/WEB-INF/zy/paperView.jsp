		...
		<div class="Previewpage">
			<div class="Previewpage_right" style="margin-left: 0px;">
				...
				<div class="Previewpage_rightwo">
					<div class="Previewpage_btn">
						<!-- <a href="#" class="Analysis">分析</a>-->
					</div>
					<div class="Previewpagebox">考卷名字</div>
					<div class="Previewpagefabu">
						考试范围：<span class='departmentOfPaper'>方向</span> &nbsp;&nbsp;考试时间：<span
							class='totalTimeOfExamPaper'></span>分钟 &nbsp;&nbsp;总分：<span
							class='totalScoreOfExamPaper'></span>
					</div>
					<div class="Previewpagebox2" style="margin-bottom: 10px")>
						<p>注意事项</p>
					...
					<div class="Previewpagebox3">
						<div class="Previewpagecontentone">
							<div class="Previewpagetable">
								<table title="评分栏" border="1" cellpadding="0" cellspacing="0"
									bordercolor="#666666"
									style="border: 1px solid rgb(102, 102, 102);">
									<tbody>
										<tr>
											<td width="55" height="20" align="center"
												style="border: 1px solid rgb(102, 102, 102);">&nbsp;评卷人&nbsp;</td>
											<td width="55" align="center"
												style="border: 1px solid rgb(102, 102, 102);">&nbsp;得&nbsp;&nbsp;分&nbsp;</td>
										</tr>
										<tr>
											<td height="30" align="center"
												style="border: 1px solid rgb(102, 102, 102);">&nbsp;</td>
						...
						<div class="Previewpagecontentwo">
							...
							<div class="quesdiv" style="display: none; margin: 10px auto">
								<div>
									<span class="quesindex"><b>1．</b></span> <span class="tips"></span>
									<span></span> <span class="tiMuTigan">题目题干</span>
									<div class="xuanXiangDiv" style="margin-left: 30px"></div>
								</div>
							</div>
							<div class="quesbox" id="danXuanTi"></div>
					...
					<div class="Previewpagebox3">
						...
						<div class="Previewpagecontentwo">
							<div class="quesbox" id="duoXuanTi"></div>
						</div>
					</div>
